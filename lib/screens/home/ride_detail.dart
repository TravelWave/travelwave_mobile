          ...
          listener: (context, state) {
            if (state is AcceptRideSuccess) {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(
                builder: (context) {
                  return RideTracking(
                      passengerData: passengerData, rideData: rideData);
                },
              ));
            }
            ...
            child: Column(
              ...
              children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            width: 80.0,
                            height: 80.0,
                            point: LatLng(driverLocation.latitude,
                          ...
                          Marker(
                            width: 80.0,
                            height: 80.0,
                            point: LatLng(rideData.startLatitude,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      passengerData.profilePicture != null
                          ? networkImageLoader(
                ...
                SizedBox(height: 24),
                BlocBuilder<AcceptRideBloc, AcceptRideState>(
                  builder: (context, state) {
                    return Padding(
                      ...
                      child: Row(
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                print(rideData.id);
                                BlocProvider.of<AcceptRideBloc>(context).add(
                                    AcceptRide(
                                        rideId: rideData.id,
                                        requestId: rideData.id,
                                        passengerId: rideData.passenger,
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                padding: state is AcceptRideLoading
                                    ? EdgeInsets.symmetric(
                                        horizontal: 32, vertical: 8)
                                    : EdgeInsets.symmetric(
                                        horizontal: 32, vertical: 16),
                              ),
                              child: state is AcceptRideLoading
